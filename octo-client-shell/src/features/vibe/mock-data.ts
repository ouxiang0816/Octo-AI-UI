...
import type { AssetRecord, ResearchDoc, Skill } from './types';
...
export const PLATFORM_ASSETS: AssetRecord[] = [
  {
    asset_id: 'plat-brand-001',
    source_type: 'platform',
    title: '企业体验规范 3.2',
    asset_type: 'design-spec',
    owner: '设计系统组',
    format: 'PDF',
    updated_at: '今天 09:20',
    tags: ['体验规范', '交付标准', '企业级'],
    summary_for_ai: '用于约束页面层级、主次按钮、表单反馈和异常状态展示，是企业正式交付的默认体验规范。',
    citation_label: '平台资产 · 企业体验规范 3.2',
    applicable_scenarios: ['正式设计交付', '页面改版', '可用性走查'],
    preview: { kind: 'document', accent: '#1476ff', secondary: '#dbeafe', label: '规范' },
    structured_payload: '优先保证主路径清晰；关键操作按钮必须使用企业主按钮样式；异常与空状态遵守标准信息结构。',
    version: 'v3.2',
    authority_level: '强制',
    review_status: '已审核',
    recent: true,
  },
  {
    ...
    updated_at: '昨天',
    tags: ['颜色', 'Token', '品牌'],
    summary_for_ai: '包含品牌主色、语义色、间距和圆角基线，用于统一界面风格与设计实现。',
    citation_label: '平台资产 · 品牌色与 Token 基线',
    applicable_scenarios: ['视觉统一', '组件设计', '代码同步输出'],
    preview: { kind: 'palette', accent: '#1476ff', secondary: '#0f172a', label: 'Token' },
    structured_payload: '主品牌蓝 #1476FF；系统圆角建议 8/12/16；间距遵守 4 的倍数；高优先级语义色需保证对比度。',
    version: 'v2.6',
    authority_level: '标准',
    review_status: '已审核',
    recent: true,
  },
  {
    ...
    updated_at: '2天前',
    tags: ['组件库', '后台', '复用'],
    summary_for_ai: '提供后台控制台常用组件模式，包括表格、筛选、空状态和批量操作条。',
    citation_label: '平台资产 · 控制台组件资产包',
    applicable_scenarios: ['后台控制台', '配置台', '数据管理'],
    preview: { kind: 'grid', accent: '#eff6ff', secondary: '#bfdbfe', label: '组件' },
    structured_payload: '列表页优先采用双层信息结构；筛选区吸顶；批量操作需要显示作用范围和风险说明。',
    version: 'v1.9',
    authority_level: '标准',
    review_status: '已审核',
  },
  {
    asset_id: 'plat-research-004',
    source_type: 'platform',
    title: 'B2B 管理后台用户研究洞察 Q2',
    asset_type: 'research',
    owner: '用研中心',
    format: 'DOCX',
    updated_at: '4天前',
    tags: ['用研', '后台', '任务效率'],
    summary_for_ai: '聚焦后台高频任务链路，指出用户更关注效率、批量操作和错误恢复能力。',
    citation_label: '平台资产 · B2B 管理后台用户研究洞察 Q2',
    applicable_scenarios: ['后台优化', '高频任务设计', '效率改版'],
    preview: { kind: 'document', accent: '#14b8a6', secondary: '#ccfbf1', label: '研究' },
    structured_payload: '高频用户关注操作效率；批量操作需减少确认层级；异常恢复路径必须明显可见。',
    version: 'v1.4',
    authority_level: '参考',
    review_status: '已审核',
  },
  {
    asset_id: 'plat-illus-005',
    source_type: 'platform',
    title: '企业空状态插画集',
    ...
    updated_at: '1周前',
    tags: ['插画', '空状态', '品牌'],
    summary_for_ai: '统一的空状态和成功反馈插画，用于保证营销感和企业品牌一致性。',
    citation_label: '平台资产 · 企业空状态插画集',
    applicable_scenarios: ['空状态', '成功反馈', '品牌露出'],
    preview: { kind: 'canvas', accent: '#f5f3ff', secondary: '#ddd6fe', label: '插画' },
    structured_payload: '优先在空状态和成功反馈中使用；避免覆盖核心内容；与品牌色基线搭配使用。',
    version: 'v1.2',
    authority_level: '参考',
    review_status: '已审核',
  },
...
export const PERSONAL_ASSETS: AssetRecord[] = [
  {
    asset_id: 'pers-delivery-101',
    ...
    updated_at: '今天 10:18',
    tags: ['结算台', '交付稿', '个人'],
    summary_for_ai: '当前项目的结算台交付稿，可作为后续页面细化和局部改版的直接参考。',
    citation_label: '个人资产 · 结算台改版交付稿',
    applicable_scenarios: ['当前项目迭代', '局部改版', '设计复用'],
    preview: { kind: 'canvas', accent: '#fef3c7', secondary: '#fde68a', label: '交付件' },
    structured_payload: '延续当前结算台的两列布局、摘要卡片样式与确认路径；优先保持已验证的字段顺序。',
    upload_source: 'cloud',
    visibility: 'private',
    recent: true,
    risk_note: '该交付稿中的高亮色偏暖，与平台品牌色存在轻微冲突。',
  },
  {
    asset_id: 'pers-research-102',
    source_type: 'personal',
    title: '访谈摘要草稿 0418',
    asset_type: 'research',
    owner: 'Vivian Chen',
    ...
    updated_at: '昨天',
    tags: ['访谈', '草稿', '洞察'],
    summary_for_ai: '最近访谈纪要草稿，包含若干一手用户原话，可用于辅助 AI 生成需求背景和设计理由。',
    citation_label: '个人资产 · 访谈摘要草稿 0418',
    applicable_scenarios: ['方案说明', '需求理解', '研究补充'],
    preview: { kind: 'document', accent: '#f472b6', secondary: '#fbcfe8', label: '草稿' },
    structured_payload: '用户倾向于一步完成关键操作；不喜欢层层确认；希望异常后能快速返回上一状态。',
    upload_source: 'cloud',
    visibility: 'private',
  },
  {
    asset_id: 'pers-template-103',
    source_type: 'personal',
    title: 'B 端深色看板探索稿',
    asset_type: 'template',
    owner: 'Vivian Chen',
    ...
    updated_at: '3天前',
    tags: ['探索稿', '深色', '看板'],
    summary_for_ai: '个人探索的深色控制台风格，用于尝试更强烈的视觉层级和品牌表现。',
    citation_label: '个人资产 · B 端深色看板探索稿',
    applicable_scenarios: ['探索方案', '视觉方向尝试', '深色模式'],
    preview: { kind: 'canvas', accent: '#0f172a', secondary: '#334155', label: '探索稿' },
    structured_payload: '使用深色背景、霓虹强调色和高密度信息布局；适合探索稿，不保证符合企业正式交付标准。',
    upload_source: 'cloud',
    visibility: 'private',
    risk_note: '探索稿使用的高饱和紫色不符合平台品牌色基线。',
  },
  {
    asset_id: 'pers-comp-104',
    source_type: 'personal',
    title: '工作台自定义筛选器',
    asset_type: 'component',
    owner: 'Vivian Chen',
    ...
    updated_at: '1周前',
    tags: ['组件', '筛选器', '工作台'],
    summary_for_ai: '个人沉淀的筛选器组件实现和交互说明，适合工作台类场景继续复用。',
    citation_label: '个人资产 · 工作台自定义筛选器',
    applicable_scenarios: ['工作台', '复杂筛选', '组件复用'],
    preview: { kind: 'grid', accent: '#ecfccb', secondary: '#bef264', label: '组件' },
    structured_payload: '筛选器支持组合条件、快速清空和收藏条件集；适合高频筛选的后台场景。',
    upload_source: 'cloud',
    visibility: 'private',
  },
];
